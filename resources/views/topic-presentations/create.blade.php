...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form method="post" action="{{ route('topics.presentations.store', [$topic]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="medium" name="medium" aria-describedby="medium-help" placeholder="Enter a medium" value="{{ old('medium') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="year" name="year" aria-describedby="year-help" placeholder="Enter a year" value="{{ old('year') }}">
                        <small id="year-help" class="form-text text-muted">What year was this presented in?</small>
                    </div>
                    <div class="form-group">
                        <label for="month">Month</label>
                        <input type="number" class="form-control" id="month" name="month" aria-describedby="month-help" placeholder="Enter a month" value="{{ old('month') }}">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="was-first-time-presenting-topic" name="was-first-time-presenting-topic" value="1"
                                @if (old('was-first-time-presenting-topic'))
                                    checked="checked"
                                @endif
                            >
